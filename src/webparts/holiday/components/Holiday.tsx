...
export default class Holiday extends React.Component<IHolidayProps, HolidayState> {
  public constructor(props: IHolidayProps, state: HolidayState) {
    super(props);
      ...
      <div className={styles.holiday}>
        ...
        <nav>
          <ul>
            <li>  Home   </li>
            <li>  About    </li>
            <li className="active"> Holidays   </li>
            <li> Permission   </li>
          </ul>
        </nav>
        <div className="container">
